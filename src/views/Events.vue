<template>
  <div>
    ...
    <v-container class="pa-4">
      ...
      <v-layout wrap v-else align-center justify-center>
            ...
            <li>
              <figure class="book">
                ...
                <ul class="hardcover_front">
                  <li>
                    <img
                      :src="'https://raccbemajesti-vision.github.io/api.vision/Events/Images/front.jpeg'"
                      alt="Loading..."
                      width="100%"
                      height="100%"
                    />
                ...
                <ul class="page">
                  <li></li>
                  <li>
                    <a class="btn" @click="$router.push(`/Events/Book`)"
                      >Read</a
                    >
                  </li>
                  <li></li>
      ...
      <center><small>Touch and swipe to read</small></center>
    </v-container>
  </div>
</template>
...
/* /////////////////////////////////////////////////// HARDCOVER Table of Contents 1. container 2. background & color 3. opening cover, back cover and pages 4. position, transform y transition 5. events 6. Bonus - Cover design - Ribbon - Figcaption 7. mini-reset ////////////////////////////////////////////////////
/*/
/* 1. container */
.book {
  position: relative;
...
.page > li {
  ...
  box-shadow: inset 0px -1px 2px rgba(172, 67, 19, 0.1),
