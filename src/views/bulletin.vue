<template>
  <div>
    <center>
      <div class="my-5">
        <span class="myHeadingBolder">Monthly</span>
        <span class="myHeadingLinear">Bulletin</span>
      </div>
    </center>
    <v-layout row wrap align-center justify-center>
      <v-flex md2 xs12 v-for="(i, j) in page" :key="j">
        <ul class="align">
          <li>
            <figure class="book">
              <!-- Front -->
...
export default {
  ...
  mounted() {
    document.title = "Rac Cbe Majestic | Bulletin";
    this.update();
  },
  methods: {
    update() {
